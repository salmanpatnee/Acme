            ...
            @if (count($portfolios))
                <div class="row portfolio-container" data-aos="fade-up">
                    @foreach ($portfolios as $portfolio)
                        {{-- @dd($portfolio->categories()->pluck('slug')) --}}
                        <div class="col-lg-4 col-md-6 portfolio-item {{ $portfolio->classes }}">
                            <img src="{{ asset($portfolio->image) }}" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>{{ $portfolio->title }}</h4>
                                <p>{{ $portfolio->categoriesList }}</p>
                                <a href="{{ asset($portfolio->image) }}" data-gall="portfolioGallery"
                                    class="venobox preview-link" title="App 1"><i class="bx bx-plus"></i></a>
                                <a href="{{ route('portfolios.show', $portfolio) }}" class="details-link"
                    ...
                    @foreach ($brands as $brand)
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="client-logo">
                                <img src="{{ $brand->thumbnail }}" class="img-fluid" alt="{{ $brand->name }}">
                            </div>
                        </div>
                    @endforeach
                @endif
